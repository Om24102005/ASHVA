    ...
    <div style="padding:30px 24px 6px">
      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:20px">
        <div>
          ...
          <div style="font-family:${F.s};font-size:30px;line-height:1;margin-top:2px">Legendary routes</div>
    ...
    <div style="padding:6px 24px 0">
      <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:18px">
        <div>
          ...
          <div style="font-family:${F.s};font-size:30px;line-height:1">Five machines</div>
    ...
    <div style="padding:0 24px">
      ${BIKES.map((b,i)=>`<div class="press" data-act="bike" data-id="${b.id}" style="display:flex;gap:16px;align-items:center;padding:16px 0;border-bottom:1px solid ${C.line2};position:relative">
        ...
        <div style="text-align:right;flex-shrink:0">
          <div style="font-family:${F.g};font-weight:600;font-size:17px;color:${C.sun}">${rupee(b.price)}</div>
          <div style="font-family:${F.m};font-size:9px;color:${C.faint};letter-spacing:.16em;margin-top:2px">PER DAY</div>
        </div>
